...
const getOffersByShopId = async (req, res, next) => {
  ...
  if (!offers) {
    return next(
      new HttpError("Could not find an offer for the provided shop id.", 404)
    );
  }
...
const getOfferById = async (req, res, next) => {
  ...
  if (!offer) {
    return next(
      new HttpError("Could not find an offer for the provided id.", 404)
    );
  }
...
const deleteOffer = async (req, res, next) => {
  ...
  try {
    ...
    return next(
      new HttpError("Could not find an offer for the provided id.", 500)
    );
  }
  ...
  try {
    ...
    return next(
      new HttpError("Could not find products for the provided id.", 500)
    );
  }
  ...
  if (!products) {
    return next(
      new HttpError(
        "Could not find any products associated with this offer",
        404
      )
    );
  }
  ...
  try {
    ...
    return next(
      new HttpError("Could not delete an offer for the provided id.", 500)
    );
  }
...
const addProduct = async (req, res, next) => {
  ...
  product.offerPrice =
    product.amount - (product.amount * offer.percentage) / 100;
